...
class plan_finacials(models.Model):
    ...
    p_name=models.ForeignKey(productsandservices, null=True, on_delete=models.CASCADE)
...
class Valuation(models.Model):
    company = models.ForeignKey(Company, on_delete=models.CASCADE)
    product = models.ForeignKey(productsandservices, on_delete=models.SET_NULL, null=True, blank=True)
    ...
    def __str__(self):
        return f"Valuation for {self.company.name}"
...
class ValuationDocument(models.Model):
    ...
    def __str__(self):
        return f"Document for {self.valuation} uploaded at {self.uploaded_at}"
