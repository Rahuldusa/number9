...
urlpatterns = [
   ...
   #Planning & Budgeting
    ...
    path('add_valuation/<str:id>/', add_valuation, name='add_valuation'),
   

    path('activate-user/<uidb64>/<token>/', activate_user, name='activate'),
    path('news/delete/<int:news_id>/', delete_news, name='delete_news'),
    path('news/update/<int:line_no>/', update_news, name='update_news'),
    path('delete_valuation/<int:id>/', delete_valuation, name='delete_valuation'),
    path('update_valuation/<int:valuation_id>/', update_valuation, name='update_valuation'),
    path('delete_document/<int:file_id>/', delete_document, name='delete_document'),
